...
<div class="container">
	...
	<div class="card">
		...
		<div class="card-body">
			<h5 class="card-title">Gestione eccezioni interno di Spring</h5>
		<p class="card-text">Exception: ${exception.message}
		<c:forEach items="${exception.stackTrace}" var="stack">${stack}</c:forEach>
